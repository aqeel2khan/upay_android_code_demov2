...
//    private var orderId_multiRefund: String?=""
    ...
    private var orderId_get_refundapi: String=""
    private var refundOrderId: String=""
    private var refund_order_id: String=""
    private var refund_order_id_fromCharge: String=""
    ...
    private fun callSingleDeleteRefundApi(){
        ...
        var orderId= orderId_get_refundapi;
        val refundOrderId=refundOrderId
    ...
    private fun callSingleRefundApi() {
        ...
        postSingleRefundData.reference = ""
...
//            }
    ...
    //Multi Charge API
    private fun callChargeApiWithExtraMerchant() {        // non whit elabel uniqu token : 886626828796
        val eventCharge = upaymentGatewayEvent3 {            // to test charge api
            productList {
                product {
                    description = "Product 1"
                    price = 25f
    ...
    override fun callBackUpayment(postUpayData: PostUpayData?) {
        if(postUpayData!=null){
            ...
            refund_order_id_fromCharge=  postUpayData.refund_order_id
            ...
            //  Toast.makeText(this,chargeApiResponse.toString(),Toast.LENGTH_SHORT).show()
    ...
    override fun sucessSingleRefund(invoiceResponse: SingleRefundResponse?) {
        if(invoiceResponse!=null){
            refundOrderId=   invoiceResponse.refundOrderId
            orderId_get_refundapi=   invoiceResponse.orderId
            val gson = Gson()
            runOnUiThread(Runnable {
    ...
    override fun sucessMultiRefund(responseMultiRefund:com.upayment.upaymentsdk.track.refund.multirefund. ResponseMultivendorRefund?) {
        val gson = Gson()
        val generated:   Generated? =  responseMultiRefund?.data?.responseData?.generated?.get(0)
        refundOrderId_multiRefund= generated?.refundOrderId.toString();
        refundArn_multiRefund=  generated?.refundArn;
        refundOrderId_multiRefund=  generated?.orderId;
